...
| [anthropic-oauth-gateway.md](./anthropic-oauth-gateway.md) | **Code complete** | crates/, services/oauth-proxy/, k8s/ | OAuth pool gateway — PKCE, token refresh, subscription pooling (supersedes oauth-proxy.md) |
