...
| [OAuth Account Management](./accounts.md) | Admin API, adding/removing/listing accounts, pool status, credential persistence |
...
| [Troubleshooting & Known Issues](./troubleshooting.md) | Pod / tailnet / 502 / 504 / 400 / 429 / pool-exhausted / latency, PKCE + credential-file issues |
...
```bash
curl -fsS https://anthropic-oauth-proxy.tailfb3ea.ts.net/health | jq .
```
